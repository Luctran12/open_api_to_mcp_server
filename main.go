...
func main() {
    ...
    specURL := "C:/Users/Lenovo/Desktop/open_api_to_mcp_server/openapi.json"
    ...
    tools, err := GenerateToolsFromOpenAPI(specURL)
    if err != nil {
    ...
    // Add all generated tools to server
    ...
    if os.Getenv("BEARER_TOKEN") != "" {
        fmt.Println("✅ BEARER_TOKEN found for authentication")
    }
    if os.Getenv("API_KEY") != "" {
        fmt.Println("✅ API_KEY found for authentication")
    }
